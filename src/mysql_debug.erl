...
-export([hexdump/1, catch_shell_exceptions/0,
         trace_module/1, trace_module/2,
         trace_function/2, trace_function/3,
         trace_messages/1, trace_messages/2,
         stop_tracing/0]).
